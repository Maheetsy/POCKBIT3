<%@ Page Title="Registrarse" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="POCKBIT_v2.Account.Register" %>
    ...
    <main aria-labelledby="title">
        ...
        <div class="row">
            <div class="offset-md-2 col-md-10">
                <asp:Button runat="server" OnClick="CreateUser_Click" Text="Registrarse" CssClass="btn btn-primary btn-md" />
            </div>
        </div>
    </main>
</asp:Content>
